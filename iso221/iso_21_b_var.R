...
pars_iso_21 = c(v, kap, mu_E1, mu_E2, mu_V, j_E1M, MV, k_J, kap_G, kap_E1, kap_E2, E_Hb);
iso_21_var_out = iso_21_var(m_E1b, m_E2b, pars_iso_21); # a_b is not corrected for temperature!
  L_b = as.numeric(unlist(iso_21_var_out[1])); a_b = as.numeric(unlist(iso_21_var_out[2])); M_E10 = iso_21_var_out[3]; M_E20 = iso_21_var_out[4];
# if info == 0
...
var_b = c(0,    0,   M_E1b,  M_E2b,  E_Hb,  E_Hb, M_Vb,  M_Vb,    0,      0,     0,  0,  1); # mol, 

return(list(var_b, a_b, M_E10, M_E20))
}