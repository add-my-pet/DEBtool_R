sgr_iso_21_var <- function(m_E1, m_E2, j_E1S, j_E2S, mu_E1, mu_E2, mu_V, k_E, kap_G, kap){
...
# created: 2012/03/07 by Bas Kooijman, R version created 2015/06/03
#
...
if(mode==2){
  # reserve 2 can fuel all somatic maintenance, but reserve 1 pays part of growth overhead
    j_E1_S = 0;
    j_E2_S = j_E2S;
    mm = mu_E1 * m_E1 + mu_E2 * m_E2;
...
if(mode==4){
 # structure pays part of somatic maintenance
...
if(!(mode %in% seq(2,4))){
  # mode = 1: reserve 2 can fuel all maintenance and growth overhead
...
return<-list(r, j_E1_S, j_E2_S, j_E1C, j_E2C, j_E1P, j_E2P, mode)
}