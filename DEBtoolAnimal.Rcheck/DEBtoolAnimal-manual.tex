...
\code{\LinkA{petregr\_f}{petregr.Rul.f}}; \code{\LinkA{results\_pets}{results.Rul.pets}}
\end{SeeAlso}
%
\begin{Examples}
\begin{ExampleCode}
...
\begin{SeeAlso}\relax
Other add-my-pet functions: \code{\LinkA{estim\_pars}{estim.Rul.pars}};
\code{\LinkA{mydata\_pets}{mydata.Rul.pets}}; \code{\LinkA{results\_pets}{results.Rul.pets}}
\end{SeeAlso}
\inputencoding{utf8}
...
\code{\LinkA{addpseudodata}{addpseudodata}}; \code{\LinkA{fieldnm\_wtxt}{fieldnm.Rul.wtxt}};
\code{\LinkA{fieldnmnst}{fieldnmnst}}; \code{\LinkA{get\_d\_V}{get.Rul.d.Rul.V}};
\code{\LinkA{parscomp}{parscomp}}; \code{\LinkA{rmpseudodata}{rmpseudodata}};
\code{\LinkA{setweights}{setweights}}
\end{SeeAlso}
%
\begin{Examples}
\begin{ExampleCode}
