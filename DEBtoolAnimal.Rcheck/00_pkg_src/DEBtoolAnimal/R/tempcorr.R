...
#' @param T_A scalar with Arrhenius temperature
#' @param T_L (optional) scalar with lower boundary of temperature range
#' @param T_AL (optional) scalar with Arrhenius temperature for lower boundary of temperature range
#' @param T_H (optional) scalar with upper boundary of temperature range
#' @param T_AH (optional) scalar with Arrhenius temperature for upper boundary of temperature range
